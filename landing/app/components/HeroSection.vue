    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
      <div class="mx-auto max-w-2xl text-center">
        <h1 class="text-4xl font-bold tracking-tight text-brand-dark sm:text-6xl">
          Your AI-Powered Resume & Portfolio in Minutes
        </h1>
        <p class="mt-6 text-lg leading-8 text-brand-gray">
          Stand out with a professional, AI-generated curriculum vitae and personal website. 
          Get a custom domain and showcase your best work instantly.
        </p>
